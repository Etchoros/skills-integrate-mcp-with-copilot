"""
Seed initial activities data into the database
"""

from database import SessionLocal, Activity, Participant, Base, engine

# Sample activities data matching the original in-memory data
INITIAL_ACTIVITIES = {
    "Chess Club": {
